...
class Model(nn.Module):
    ...
    def __build_model(self):
        ...
        self.linear1 = nn.Linear(self.n_kernels, self.n_kernels)
        self.linear2 = nn.Linear(self.n_kernels, self.n_kernels)
        self.linear3 = nn.Linear(self.n_kernels, 2)
    ...
    def forward(self, x):
        ...
        nonlinear_output = self.active_func(self.linear3(ampo_output))
